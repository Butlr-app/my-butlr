  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        ...
        tabIndex={-1}
        className={cn(
          'relative bg-card border border-border rounded-lg shadow-[var(--shadow-3)] w-full max-w-xl max-h-[85vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200',
          className
        )}>
        {title && (
